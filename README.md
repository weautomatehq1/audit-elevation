...
6 repos baselined (IFleet, factory, PhillUp, discord-claude-bot, ~/.claude, audit-elevation) as of 2026-05-21 (initial baseline: 52 findings, 6C/37I/9CO — all since closed across nightly audit runs). Current open findings: see `.audits/index.json` for live count.
